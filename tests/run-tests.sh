...
"$TMP/client-tests"
swiftc -parse-as-library -framework AppKit -framework CoreText "$SOURCE/app/MailFontResolver.swift" "$SOURCE/app/MailTypography.swift" "$ROOT/tests/MailTypographyTests.swift" -o "$TMP/typography-tests"
