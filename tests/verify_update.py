...
assert manifest['version'] == '1.68.0' and manifest['build'] == 69
assert manifest['download_url'] == 'Replyzen-update-1.68.zip'
...
print('PASS: 1.68 version/build, bundle identity, archive, SHA-256, binary and icons')
