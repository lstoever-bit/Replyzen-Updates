...
assert manifest['version'] == '1.60.0' and manifest['build'] == 61
assert manifest['download_url'] == 'Replyzen-update-1.60.zip'
...
print('PASS: 1.60 version/build, bundle identity, archive, SHA-256, binary and icons')
