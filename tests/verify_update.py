...
assert manifest['version'] == '1.58.0' and manifest['build'] == 59
assert manifest['download_url'] == 'Replyzen-update-1.58.zip'
...
print('PASS: 1.58 version/build, bundle identity, archive, SHA-256, binary and icons')
