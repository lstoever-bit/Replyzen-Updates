...
assert manifest['version'] == '1.63.0' and manifest['build'] == 64
assert manifest['download_url'] == 'Replyzen-update-1.63.zip'
...
print('PASS: 1.63 version/build, bundle identity, archive, SHA-256, binary and icons')
