...
assert manifest['version'] == '1.62.0' and manifest['build'] == 63
assert manifest['download_url'] == 'Replyzen-update-1.62.zip'
...
print('PASS: 1.62 version/build, bundle identity, archive, SHA-256, binary and icons')
