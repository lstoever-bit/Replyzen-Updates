...
assert manifest['version'] == '1.59.0' and manifest['build'] == 60
assert manifest['download_url'] == 'Replyzen-update-1.59.zip'
...
print('PASS: 1.59 version/build, bundle identity, archive, SHA-256, binary and icons')
