...
assert manifest['version'] == '1.53.0' and manifest['build'] == 54
assert manifest['download_url'] == 'Replyzen-update-1.53.zip'
...
print('PASS: 1.53 version/build, bundle identity, archive, SHA-256, binary and icons')
