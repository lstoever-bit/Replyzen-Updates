...
assert manifest['version'] == '1.67.0' and manifest['build'] == 68
assert manifest['download_url'] == 'Replyzen-update-1.67.zip'
...
print('PASS: 1.67 version/build, bundle identity, archive, SHA-256, binary and icons')
