...
assert manifest['version'] == '1.65.0' and manifest['build'] == 66
assert manifest['download_url'] == 'Replyzen-update-1.65.zip'
...
print('PASS: 1.65 version/build, bundle identity, archive, SHA-256, binary and icons')
