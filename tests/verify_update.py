...
assert manifest['version'] == '1.45.0' and manifest['build'] == 46
assert manifest['download_url'] == 'Replyzen-update-1.45.zip'
...
print('PASS: 1.45 version/build, bundle identity, archive, SHA-256, binary and icons')
