...
assert manifest['version'] == '1.50.0' and manifest['build'] == 51
assert manifest['download_url'] == 'Replyzen-update-1.50.zip'
...
print('PASS: 1.50 version/build, bundle identity, archive, SHA-256, binary and icons')
