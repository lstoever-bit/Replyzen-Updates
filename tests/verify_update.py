...
assert manifest['version'] == '1.69.0' and manifest['build'] == 70
assert manifest['download_url'] == 'Replyzen-update-1.69.zip'
...
print('PASS: 1.69 version/build, bundle identity, archive, SHA-256, binary and icons')
