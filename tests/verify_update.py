...
assert manifest['version'] == '1.61.0' and manifest['build'] == 62
assert manifest['download_url'] == 'Replyzen-update-1.61.zip'
...
print('PASS: 1.61 version/build, bundle identity, archive, SHA-256, binary and icons')
