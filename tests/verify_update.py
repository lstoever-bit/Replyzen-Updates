...
assert manifest['version'] == '1.49.0' and manifest['build'] == 50
assert manifest['download_url'] == 'Replyzen-update-1.49.zip'
...
print('PASS: 1.49 version/build, bundle identity, archive, SHA-256, binary and icons')
