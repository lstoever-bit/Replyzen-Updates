...
assert manifest['version'] == '1.56.0' and manifest['build'] == 57
assert manifest['download_url'] == 'Replyzen-update-1.56.zip'
...
print('PASS: 1.56 version/build, bundle identity, archive, SHA-256, binary and icons')
