...
assert manifest['version'] == '1.64.0' and manifest['build'] == 65
assert manifest['download_url'] == 'Replyzen-update-1.64.zip'
...
print('PASS: 1.64 version/build, bundle identity, archive, SHA-256, binary and icons')
