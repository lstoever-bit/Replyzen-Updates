...
assert manifest['version'] == '1.66.0' and manifest['build'] == 67
assert manifest['download_url'] == 'Replyzen-update-1.66.zip'
...
print('PASS: 1.66 version/build, bundle identity, archive, SHA-256, binary and icons')
