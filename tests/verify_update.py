...
assert manifest['version'] == '1.57.0' and manifest['build'] == 58
assert manifest['download_url'] == 'Replyzen-update-1.57.zip'
...
print('PASS: 1.57 version/build, bundle identity, archive, SHA-256, binary and icons')
