...
assert manifest['version'] == '1.70.0' and manifest['build'] == 71
assert manifest['download_url'] == 'Replyzen-update-1.70.zip'
...
print('PASS: 1.70 version/build, bundle identity, archive, SHA-256, binary and icons')
