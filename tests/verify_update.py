...
assert manifest['version'] == '1.44.0' and manifest['build'] == 45
assert manifest['download_url'] == 'Replyzen-update-1.44.zip'
...
print('PASS: 1.44 version/build, bundle identity, archive, SHA-256, binary and icons')
